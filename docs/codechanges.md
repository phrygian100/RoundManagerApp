...
- **Shared swap proposals**: 🔄 Temporarily reverted to local state (Firestore implementation pending)
...
- **Local swap proposals**: Out-of-order suggestions work within single user session (collaborative sharing pending)
