...
- **Shared swap proposals**: ✅ Implemented with Firestore persistence and real-time sync
...
- **Shared swap proposals**: Out-of-order suggestions are visible to all team members in real-time
- **Collaborative day completion**: Owner accounts see swap proposals generated by any team member
