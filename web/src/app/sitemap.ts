...
const ROUTES: { path: string; priority: number }[] = [
  ...
  // Guides
  { path: "/guides/gettingstarted/", priority: 0.6 },
  { path: "/guides/migrationguide/", priority: 0.6 },
  { path: "/guides/importing/", priority: 0.6 },
  ...
  { path: "/guides/manageservices/", priority: 0.6 },
  { path: "/guides/completedjobs/", priority: 0.6 },
  { path: "/guides/exclients/", priority: 0.6 },
  { path: "/guides/rota/", priority: 0.6 },
  { path: "/guides/quotes/", priority: 0.6 },
  { path: "/guides/quotepage/", priority: 0.6 },
  { path: "/guides/quotewizard/", priority: 0.6 },
  { path: "/guides/materials/", priority: 0.6 },
  { path: "/guides/accountsguide/", priority: 0.6 },
  { path: "/guides/payments/", priority: 0.6 },
  { path: "/guides/chasingpayments/", priority: 0.6 },
  { path: "/guides/gocardlesssetup/", priority: 0.6 },
  { path: "/guides/settings/", priority: 0.6 },
  { path: "/guides/memberaccounts/", priority: 0.6 },
  { path: "/guides/subscription/", priority: 0.6 },
  { path: "/guides/billing/", priority: 0.6 },
  { path: "/guides/auditlog/", priority: 0.6 },
  // Legal
