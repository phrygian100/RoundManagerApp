...
// window cleaner (funnel to /window-cleaning-quote). Secondary: service
// providers, via the band above the footer and the Sign in button.
...
export default function WelcomeScreen() {
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.pageContent}>
      {Platform.OS === 'web' && (
        <Head>
          <title>Guvnor — Find a Local Window Cleaner</title>
          <meta
            name="description"
            content="Get a free, no-obligation window cleaning quote anywhere in the UK. Guvnor connects you with trusted local window cleaners."
          />
        </Head>
      )}
      ...
      <View style={styles.main}>
        <View style={styles.hero}>
          ...
          <Text style={[styles.heroSubtitle, isNarrow && styles.heroSubtitleMobile]}>
            Get a free, no-obligation quote from a trusted local window cleaner.
            Wherever you are in the UK, we&apos;ll connect you with the right person
            for the job.
          </Text>

          <Pressable onPress={() => go('/window-cleaning-quote')} style={styles.ctaButton}>
        ...
        <View style={styles.steps}>
          ...
          <View style={[styles.stepsRow, isNarrow && styles.stepsRowMobile]}>
            {[
              { n: '1', title: 'Tell us about your home', text: 'A few quick details — your address and how often you\u2019d like your windows cleaned.' },
              { n: '2', title: 'We find your local pro', text: 'We match your request with a trusted window cleaner working in your area.' },
              { n: '3', title: 'Get your quote', text: 'Your window cleaner gets in touch to confirm your quote and first visit.' },
            ].map((s) => (
          ...
          <Pressable onPress={() => go('/window-cleaning-quote')} style={styles.ctaButtonSecondary}>
